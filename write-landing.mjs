  ...
  return (
    <div className="landing">
      ...
      <section className="landing__hero">
        ...
        <div className="landing__hero-inner">
          <div className="landing__badge">
            ...
            Lightweight \xb7 Cloud-free \xb7 Privacy-first
          </div>
      ...
      <footer className="landing__footer">
        ...
        <span>Powered by GitHub API \xb7 OAuth 2.0 PKCE \xb7 No backend required</span>
...
writeFileSync('src/pages/LandingPage.tsx', tsx, 'utf8');
console.log('OK:', tsx.split('\n').length, 'lines written');
